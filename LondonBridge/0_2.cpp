...
void lighting(){
   ...
   GLfloat position[] = {-10,100.0*cos(Angle),100.0*sin(Angle),1.0};
   ...
   glLightfv(GL_LIGHT1, GL_POSITION, position);
      ...
      //  glMaterialfv(GL_FRONT, GL_SHININESS, high_shininess);
        ...
        glPushMatrix();
        //glTranslatef(0,0,0);
        glTranslatef (-10,100.0*cos(Angle),100.0*sin(Angle));  // change angle based on key
...
//	gluLookAt(-30,-30,50,	0,0,0,	0,0,1);
    ...
    ****************************/
    ...
    glRotatef(45,0,0,1);
     ...
     glTranslatef(-40,-5,-45);
     down_angle_road_rev();
     glTranslatef(40,5,45);



      glTranslatef(90,20,45);
      //glRotatef(-90,0,1,0);
     drawsphere(55,3,4);
     //glRotatef(+90,0,1,0);
     glTranslatef(-90,-20,-45);
     ...
     //glRotatef(+90,0,1,0);
     glTranslatef(-100,-20,-45);
     glTranslatef(110,20,45);
      //glRotatef(-90,0,1,0);
     drawsphere(35,3,4);
     //glRotatef(+90,0,1,0);
     glTranslatef(-110,-20,-45);

      glTranslatef(120,20,45);
      //glRotatef(-90,0,1,0);
     drawsphere(25,3,4);
     //glRotatef(+90,0,1,0);
     glTranslatef(-120,-20,-45);
       ...
       glTranslatef(90,-5,45);
      //glRotatef(-90,0,1,0);
     drawsphere(55,3,4);
     //glRotatef(+90,0,1,0);
     glTranslatef(-90,+5,-45);

      glTranslatef(100,-5,45);
      //glRotatef(-90,0,1,0);
     drawsphere(45,3,4);
     //glRotatef(+90,0,1,0);
     glTranslatef(-100,+5,-45);
     glTranslatef(110,-5,40);
      //glRotatef(-90,0,1,0);
     drawsphere(35,3,4);
     //glRotatef(+90,0,1,0);
     glTranslatef(-110,+5,-45);

      glTranslatef(120,-5,45);
      //glRotatef(-90,0,1,0);
     drawsphere(25,3,4);
     //glRotatef(+90,0,1,0);
     glTranslatef(-120,+5,-45);
    ...
    glPushMatrix();
    {
glTranslatef(+75,+20,115);

     glRotatef(135,0,1,0);
     drawsphere(115,3,8);
     glTranslatef(-75,-15,-115);

    }glPopMatrix();

  glPushMatrix();
    {
glTranslatef(+75,-5,115);
